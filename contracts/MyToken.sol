...
contract MyToken is ERC20 {
     ...
     * Mints an initial supply of 500,000 MJT tokens to the owner's address.
     */
    constructor() ERC20("MICJOHNTOKEN", "MJT") {
        // Set the owner to the address that deploys the contract
        owner = msg.sender;

        // Mint an initial supply of 500,000 MJT tokens to the owner
